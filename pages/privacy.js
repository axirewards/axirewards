  ...
  return (
    <Layout>
      <div className="flex flex-col items-center justify-center min-h-[60vh] bg-card rounded-xl shadow-lg py-12 px-4 md:px-8">
        <h1 className="text-3xl font-extrabold text-primary mb-6 text-center">Privacy Policy</h1>
        <div className="text-primary text-lg max-w-2xl mx-auto space-y-6 text-left">
          ...
          <ol className="list-decimal list-inside space-y-4">
            <li>
              <b>Information We Collect:</b> We collect information you provide during registration (such as email address and wallet address), as well as data related to your use of our services (like points balance, offer completions, and payout requests).
            </li>
            <li>
              <b>How We Use Your Information:</b> Your information is used to operate and improve the platform, deliver rewards, process payouts, and provide support. We may also use data for analytics and to prevent fraud.
            </li>
            <li>
