...
export default function MiniLoadingSpinner({ loading }) {
  return (
    <Transition
      show={!!loading}
      as="div" // <-- PAGRINDINIS pakeitimas: "div" vietoj Fragment!
      ...
      className="fixed inset-0 z-[1000] flex items-center justify-center pointer-events-none bg-black/30 backdrop-blur-sm"
    >
